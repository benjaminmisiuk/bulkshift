...
#' If `method = 'randomForest` the default `nodesize` is `n/10` of the overlapping raster cells to prevent overfitting on highly redundant data with a low number of predictors.
#' 
